...
namespace HotelManagement.Controllers
{
    public class Room_TypeController : ApiController
    {
        ...
        // GET: api/Room_Type
        public IQueryable<Room_Type> Get()
        {
            return db.Room_Type;
        }
        ...
        [HttpGet]
        public IQueryable<List_Rooms> GetRoom_Type(string room_Type_Description)
        {
            var query = from a in db.Rooms
                        ...
                        where c.room_Type_Description == room_Type_Description
        ...
        public IHttpActionResult GetRoom_Type(int id)
        {
        ...
        public IHttpActionResult PutRoom_Type(int id, Room_Type room_Type)
        {
        ...
        [ResponseType(typeof(Room_Type))]
        public IHttpActionResult DeleteRoom_Type(int id)
        {
            Room_Type room_Type = db.Room_Type.Find(id);
            if (room_Type == null)
            {
