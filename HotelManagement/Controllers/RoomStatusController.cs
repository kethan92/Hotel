...
namespace HotelManagement.Controllers
{
    public class RoomStatusController : ApiController
    {
        ...
        public IHttpActionResult PutRoom_Status(int id, Room_Status room_Status)
        {
        ...
        [ResponseType(typeof(Room_Status))]
        public IHttpActionResult DeleteRoom_Status(int id)
        {
            Room_Status room_Status = db.Room_Status.Find(id);
            if (room_Status == null)
            {
        ...
        private bool Room_StatusExists(int id)
        {
